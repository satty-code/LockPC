...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('partnumber', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='poc.customer')),
                ('part_number', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='poc.computationresourcetype')),
            ],
        ),
    ]
